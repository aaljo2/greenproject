...
export default function EditProduct ({match}) {
  ...
  const handleChange = name => event => {
    ...
    if (values.redirect) {
      return (<Redirect to={'/shop/seller/shop/edit/'+match.params.shopId}/>)
    }
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          ...
          <Link to={'/shop/seller/shops/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Cancel</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
